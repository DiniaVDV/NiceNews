...
<br/>
    ...
    <div class="form-group">
        {!! Form::label('user_name', 'Автор:') !!}
        {!! Form::select('user_name[]', $users, isset($article) ? $article->users_name : null, ['id' => 'users_name', 'class' => 'form-control']) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        {!! Form::select('category_name[]', $categories, isset($article) ? $article->category_name : null, ['id' => 'category_name', 'class' => 'form-control']) !!}
